...
SRC_FILES = main.cpp Movie.cpp Recommender.cpp User.cpp 
# ALL HEADER FILES THAT ARE PART OF THE PROJECT
H_FILES = IEntity.h IRecommender.h Movie.h Recommender.h User.h
# ANY OTHER RESOURCES FILES THAT ARE PART OF THE PROJECT
REZ_FILES = movies.csv final.txt
# YOUR USERNAME
USERNAME = bayasgalan_zorigt
...
# DEPENDENCIES
main.o: main.cpp Recommender.h IRecommender.h Movie.h IEntity.h User.h
Movie.o: Movie.cpp Movie.h IEntity.h
Recommender.o: Recommender.cpp Recommender.h IRecommender.h Movie.h \
  IEntity.h User.h
User.o: User.cpp User.h IEntity.h
